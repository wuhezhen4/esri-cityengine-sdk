...
public:
	 ...
	 *
	 @verbatim
	 PROJ_X, PROJ_Y:            The x,y coordinates of the projected coordinate system (i.e. cga's x,-z axis)
	 WGS84_LAT, WGS84_LON:      The WGS84 lat/lon coordinates
	 WGS84_ALT_METER:           The WGS84 altitude in meters
	 LAYER_X, LAYER_Y, LAYER_Z: The layer coordinates. Layer coordinates are not used internally by cga but some encoders
	                            might rely on this.
	 @endverbatim
	 */
	enum CoordSelector {
		PROJ_X, PROJ_Y, WGS84_LAT, WGS84_LON, WGS84_ALT_METER, LAYER_X, LAYER_Y, LAYER_Z };

	/**
	 * Function to convert world coordinates from the cga coordinate system (right handed y-up, meters) to
	 * a cartesian scene coordiante system, geographical WGS84 coordinates or client-dependent layer coordinates.
	 *
...
public:
	 ...
	 *                  which contributet to the content in this entity.
