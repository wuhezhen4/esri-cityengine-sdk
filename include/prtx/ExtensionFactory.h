 ...
 * not be sub-classed directly, use AdaptorFactory, DecoderFactory or
 * EncoderFactory for your own extensions.
 *
...
class PRTX_EXPORTS_API ExtensionFactory : boost::noncopyable {
protected:
	ExtensionFactory() { }
