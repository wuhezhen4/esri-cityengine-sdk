...
class CGAError;
typedef boost::shared_ptr<CGAError> CGAErrorPtr;
...
class AssetError;
typedef boost::shared_ptr<AssetError> AssetErrorPtr;
typedef std::vector<AssetErrorPtr>    AssetErrorPtrVector;

/**
 * Class to describe an Asset error. These are typically isssued by a decoder.
 */
class AssetError {
public:
