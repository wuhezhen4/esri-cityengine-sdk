...
#ifdef _MSC_VER
#	ifdef PRT_CC_DBG
#		pragma message(__FILE__": disabling MSVC warnings 4251 4231 4275 4660")
#	endif
#	pragma warning(push)
...
class TrimPlane;
typedef boost::shared_ptr<TrimPlane> TrimPlanePtr;			///< shared TrimPlane pointer
 ...
 *
 */
class PRTX_EXPORTS_API TrimPlane : public boost::noncopyable {
public:
	virtual ~TrimPlane();
