...
class OptionStates;
typedef boost::shared_ptr<OptionStates> OptionStatesPtr;
...
typedef boost::shared_ptr<EncodeOptionsValidator> EncodeOptionsValidatorPtr; ///< shared pointer for prtx::EncodeOptionsValidator
...
public:
	...
	virtual ~EncodeOptionsValidator() { }
