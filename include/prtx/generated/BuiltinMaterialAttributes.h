...
public:
	...
	virtual double color_a() const = 0;
...
protected:
	// BuiltinAttributesGetters interface
	...
	// BuiltinAttributes interface
	virtual const wchar_t** getBoolAttrKeys() const;
	virtual const wchar_t** getFloatAttrKeys() const;
	virtual const wchar_t** getStringAttrKeys() const;
...
public:
	...
	virtual void color_a(double val) = 0;
