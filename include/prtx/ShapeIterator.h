...
public:
	/**
	 * @returns a valid shared pointer to the next shape while there are any or a NULL pointer if there are no more shapes.
	 */
...
typedef boost::shared_ptr<DepthFirstIterator> DepthFirstIteratorPtr;
...
typedef boost::shared_ptr<BreadthFirstIterator> BreadthFirstIteratorPtr;
...
class LeafIterator;
typedef boost::shared_ptr<LeafIterator> LeafIteratorPtr;
...
typedef boost::shared_ptr<InitialShapeIterator> InitialShapeIteratorPtr;
...
typedef boost::shared_ptr<SelectedShapesIterator> SelectedShapesIteratorPtr;
...
typedef boost::shared_ptr<CGAPrintIterator> CGAPrintIteratorPtr;
...
typedef boost::shared_ptr<CGAErrorIterator> CGAErrorIteratorPtr;
...
typedef boost::shared_ptr<CGAReportIterator> CGAReportIteratorPtr;
